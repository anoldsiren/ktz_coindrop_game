...
let setFruits = {
  ...
  startFruits: reverseLevelUp ? [10, 10, 9, 8, 8, 7] : [3, 3, 4, 1, 2, 3],
  randomFunction: () => {
...
let adLink = 'https://t.me/kill_the_zero';

// 修改网页标题：将 "KillTheZero" 进行替换
document.getElementsByTagName("title")[0].innerText = 'KillTheZero';

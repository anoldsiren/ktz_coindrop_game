...
const maxRandomFruitNum = reverseLevelUp ? 11 : 3; // 生成随机水果最大值（1-11）0 为葡萄，9 为半个西瓜
let setFruits = {
  // 指定前几次生成的水果，可填入任意数量的数字，0 为葡萄，9 为半个西瓜
  startFruits: reverseLevelUp ? [10, 10, 9, 8, 8, 7] : [3, 0, 2, 0, 2, 4],
  randomFunction: () => {
...
let adLink = 'https://t.me/killthezero_korea';

// 修改网页标题：将 "合成大西瓜" 进行替换
document.getElementsByTagName("title")[0].innerText = '킬더제로프로젝트';
